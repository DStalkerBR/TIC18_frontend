...
var Artigo = /** @class */ (function () {
    ...
    Artigo.prototype.renderHTML = function () {
        ...
        return "<p>\n                    <strong>".concat(this.headline, "</strong><br>\n                    <a href='https://news.uark.edu/articles/").concat(this.id, "'>").concat(briefText, "</a>\n                </p>");
    };
    return Artigo;
}());
document.addEventListener('DOMContentLoaded', function () { return __awaiter(_this, void 0, void 0, function () {
    var articlesData, articles, artigos, dataDisplay_1, noticiasSection, blocoArticle, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch('https://campusdata.uark.edu/apiv2/articles/SearchArticle?$orderby=publishDate+desc&$top=3')];
            case 1:
                articlesData = _a.sent();
                return [4 /*yield*/, articlesData.json()];
            case 2:
                articles = _a.sent();
                artigos = articles.map(function (a) { return new Artigo(a.headline, a.id, a.brief); });
                dataDisplay_1 = "";
                artigos.forEach(function (artigo) {
                    dataDisplay_1 += artigo.renderHTML();
                });
                noticiasSection = document.getElementById('noticias');
                if (noticiasSection) {
                    blocoArticle = noticiasSection.querySelector('.bloco');
                    if (blocoArticle) {
                        blocoArticle.innerHTML = dataDisplay_1;
                    }
                }
                return [3 /*break*/, 4];
            case 3:
...
document.addEventListener('DOMContentLoaded', function () { return __awaiter(_this, void 0, void 0, function () {
    var latitude, longitude, url, climaData, data, currentTemperature, currentHumidity, currentWindSpeed, weatherCode, servicos, dataDisplay_2, servicosSection, blocoArticle, error_2;
    var _a, _b, _c, _d;
        ...
        switch (_e.label) {
            ...
            case 3:
                ...
                if (currentTemperature !== undefined && currentHumidity !== undefined && currentWindSpeed !== undefined) {
                    servicos = [
                        new Servico('Condição Atual em Uesc', Servico.obterEmojiClima(weatherCode), currentTemperature, currentHumidity, currentWindSpeed)
                    ];
                    dataDisplay_2 = "";
                    servicos.forEach(function (servico) {
                        dataDisplay_2 += servico.renderHTML();
                    });
                    servicosSection = document.getElementById('servicos');
                    if (servicosSection) {
                        blocoArticle = servicosSection.querySelector('.bloco');
                        if (blocoArticle) {
                            blocoArticle.innerHTML = dataDisplay_2;
                        }
                    }
                }
                else {
            ...
            case 4:
                error_2 = _e.sent();
                console.error('Error Não foi possível obter dados do clima:', error_2);
                return [3 /*break*/, 5];
...
var Destaque = /** @class */ (function () {
    ...
    Destaque.prototype.renderHTML = function () {
        return "<img src=\"".concat(this.imagem1, "\" alt=\"\">\n                <img src=\"").concat(this.imagem2, "\" alt=\"\">");
    };
    return Destaque;
}());
document.addEventListener('DOMContentLoaded', function () { return __awaiter(_this, void 0, void 0, function () {
    var destaque, destaqueHTML, blocoArticle, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Destaque.obterImagensAcademicas()];
            case 1:
                destaque = _a.sent();
            ...
            case 2:
                error_3 = _a.sent();
                console.error('Erro ao obter imagens do Unsplash:', error_3);
                return [3 /*break*/, 3];
...
var Resultados = /** @class */ (function () {
    ...
    Resultados.prototype.truncarTexto = function (texto, limitePalavras) {
        ...
        var truncado = palavras.join(' ');
        if (palavras.length < texto.split(' ').length) {
            return "".concat(truncado, " ...");
        }
        return truncado;
    };
    Resultados.prototype.renderHTML = function () {
        ...
        var noticiasHTML = this.noticias
            .map(function (noticia) { return "<p><strong>".concat(_this.truncarTexto(noticia.title, 10), "</strong><br>\n                              ").concat(_this.truncarTexto(noticia.summary, 10), "<br>\n                              <a href=\"").concat(noticia.url, "\">Leia mais</a></p>"); })
            .join('');
        return noticiasHTML;
    };
    return Resultados;
...
document.addEventListener('DOMContentLoaded', function () { return __awaiter(_this, void 0, void 0, function () {
    var resultados, blocoArticle, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Resultados.obterNoticias()];
            case 1:
                resultados = _a.sent();
            ...
            case 2:
                error_4 = _a.sent();
                console.error('Erro ao obter notícias:', error_4);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
